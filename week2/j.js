        ...
        window.onload = function () {
            ...
            province.onclick = function () {
                ...
                for (var i = 0; i < 31; i++) {
                    ...
                    option.value = a[i].item_code;
                    option.innerHTML = a[i].item_name;
                ...
                province.onclick = function () {
                    ...
                    selects[1].options.length = 0;
                    selects[2].options.length = 0;
                    option.value = "请选择你的城市";
                    option.innerHTML = "请选择你的城市";
                    ...
                    city.onclick = function () {
                        ...
                        for (var i = 31; i < 367; i++) {
                            if (a[i].item_code[0] == p[0] && a[i].item_code[1] == p[1]) {
                                var option = document.createElement("option");
                                option.value = a[i].item_code;
                                option.innerHTML = a[i].item_name;
                                selects[1].appendChild(option);
                        ...
                        city.onclick = function () {
                            ...
                            option.value = "请选择你的县镇";
                            option.innerHTML = "请选择你的县镇";
                            ...
                            town.onclick = function () {
                                ...
                                for (var i = 367; i < 400 + 2844; i++) {
                                    if (a[i].item_code[0] == p[0] && a[i].item_code[1] == p[1] && a[i].item_code[2] == c[2] && a[i].item_code[3] == c[3]) {
                                        var option = document.createElement("option");
                                        option.value = a[i].item_code;
                                        option.innerHTML = a[i].item_name;
                                        selects[2].appendChild(option);
